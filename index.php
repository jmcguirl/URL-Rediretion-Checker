...
<html>
    <head>
        ...
        <title>URL Redirection Checker | Displays HTTP(S) redirects and their response codes</title>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="results">
                ...
                to the final page. Enter your URL in the box above and you will
                ...
                typing <i>www.cats.com</i>, <i>cats.com</i> or <i>cats.com/index.php</i> should always be redirected to a single URL, <i>www.cats.com</i> for example.</p>
            </div>
